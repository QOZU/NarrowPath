...
#[derive(Debug)]
pub struct NarrowPathProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NarrowPathProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NarrowPath processing");
    
    let mut processor = NarrowPathProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NarrowPathProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NarrowPathProcessor::new(false);
